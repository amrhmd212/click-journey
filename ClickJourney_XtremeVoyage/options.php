...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['service'])) {
        ...
        if (!in_array($service, $_SESSION['options_supplementaires'])) {
            $_SESSION['options_supplementaires'][] = $service;
        }
    }
}
?>
...
<body>
                        ...
                        <div class="card-container">
                            <form method="POST" action="options.php">
                                <div class="hotel-option">
                                    ...
                                    <button type="submit" class="hotel-select-btn">Sélectionner</button>
                                </div>
                            </form>
            ...
            <div class="card-container">
                <form method="POST" action="options.php">
                    <div class="service-option">
                        ...
                        <button type="submit" class="service-select-btn">
                            <i class="fas fa-plus-circle"></i> Sélectionner
                        </button>
                    </div>
                </form>
                ...
                <form method="POST" action="options.php">
                    <div class="service-option">
                        <img src="https://www.ecranmobile.fr/photo/art/grande/80811125-58276840.jpg?v=1717774410" alt="Option Petit-déjeuner">
                        <h3><i class="fas fa-coffee"></i>5G illimité</h3>
                        <p>
                        ...
                        <input type="hidden" name="service" value="Petit déjeuner">
                ...
                <form method="POST" action="options.php">
                    <div class="service-option">
                        ...
                        <h3><i class="fas fa-car"></i> Location de Voiture Premium</h3>
                        <p>
                        ...
                        <div class="price-tag">À partir de 70€/jour</div>
    ...
    <div style="position: fixed; bottom: 20px; width: 100%; display: flex; justify-content: space-between; padding: 0 20px; box-sizing: border-box;">
        ...
        <a href="recap.php" style="display: inline-block; background: linear-gradient(45deg, #ff7b25, #e63946); color: white; padding: 15px 20px; border-radius: 8px; text-decoration: none; font-size: 1.2rem; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.2); transition: transform 0.3s ease, box-shadow 0.3s ease;" onmouseover="this.style.transform='scale(1.05)'; this.style.boxShadow='0 6px 15px rgba(0, 0, 0, 0.3)';" onmouseout="this.style.transform='scale(1)'; this.style.boxShadow='0 4px 10px rgba(0, 0, 0, 0.2)';">Récapitulatif →</a>
    </div>
