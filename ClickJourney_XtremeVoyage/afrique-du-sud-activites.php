            ...
            <section class="activity-grid">
                <div class="activity-card">
                    ...
                    <div class="activity-actions">
                        ...
                        <input type="hidden" name="activites[Saut à l'élastique du Bloukrans Bridge]" value="0">
                    </div>
                </div>
                ...
                <div class="activity-card">
                    ...
                    <div class="activity-actions">
                        ...
                        <input type="hidden" name="activites[Plongée en cage avec les requins]" value="0">
                    </div>
                </div>
                ...
                <div class="activity-card">
                    ...
                    <div class="activity-actions">
                        ...
                        <input type="hidden" name="activites[Le Big Swing de Graskop Gorge]" value="0">
                    </div>
                </div>
                ...
                <div class="activity-card">
                    ...
                    <div class="activity-actions">
                        ...
                        <input type="hidden" name="activites[Safari à pied avec les Big Five]" value="0">
                    </div>
                </div>
                ...
                <div class="activity-card">
                    ...
                    <div class="activity-actions">
                        ...
                        <input type="hidden" name="activites[Spéléologie dans les grottes de Cango]" value="0">
                    </div>
                </div>
            </section>
