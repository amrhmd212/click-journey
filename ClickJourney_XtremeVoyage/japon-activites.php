            ...
            <section class="activity-grid">
                <div class="activity-card">
                    ...
                    <div class="activity-actions">
                        ...
                        <input type="hidden" name="activites[Wingsuit au Mont Fuji]" value="0">
                    </div>
                </div>
                ...
                <div class="activity-card">
                    ...
                    <div class="activity-actions">
                        ...
                        <input type="hidden" name="activites[Ice climbing sur les cascades gelées de Sounkyo]" value="0">
                    </div>
                </div>
                ...
                <div class="activity-card">
                    ...
                    <div class="activity-actions">
                        ...
                        <input type="hidden" name="activites[Affronter un ours brun en 'battle mode']" value="0">
                    </div>
                </div>
                ...
                <div class="activity-card">
                    ...
                    <div class="activity-actions">
                        ...
                        <input type="hidden" name="activites[Plongée sous glace à Shiretoko]" value="0">
                    </div>
                </div>
                ...
                <div class="activity-card">
                    ...
                    <div class="activity-actions">
                        ...
                        <input type="hidden" name="activites[Snowboard sur les pentes du Mt. Yotei]" value="0">
                    </div>
                </div>
            </section>
