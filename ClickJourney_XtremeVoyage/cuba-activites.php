            ...
            <section class="activity-grid">
                <div class="activity-card">
                    ...
                    <div class="activity-actions">
                        ...
                        <input type="hidden" name="activites[Excursion au parc national de Topes de Collantes]" value="0">
                    </div>
                </div>
                ...
                <div class="activity-card">
                    ...
                    <div class="activity-actions">
                        ...
                        <input type="hidden" name="activites[Découverte de la Vallée de Viñales]" value="0">
                    </div>
                </div>
                ...
                <div class="activity-card">
                    ...
                    <div class="activity-actions">
                        ...
                        <input type="hidden" name="activites[Croisière en vieux voilier]" value="0">
                    </div>
                </div>
                ...
                <div class="activity-card">
                    ...
                    <div class="activity-actions">
                        ...
                        <input type="hidden" name="activites[Visite de la forteresse Castillo del Morro]" value="0">
                    </div>
                </div>
                ...
                <div class="activity-card">
                    ...
                    <div class="activity-actions">
                        ...
                        <input type="hidden" name="activites[Promenade en voiture américaine vintage]" value="0">
                    </div>
                </div>
            </section>
