            ...
            <section class="activity-grid">
                <div class="activity-card">
                    ...
                    <div class="activity-actions">
                        ...
                        <input type="hidden" name="activites[Monter à dos de chameau dans le désert de Merzouga]" value="0">
                    </div>
                </div>
                ...
                <div class="activity-card">
                    ...
                    <div class="activity-actions">
                        ...
                        <input type="hidden" name="activites[Déguster un thé à la menthe dans un riad]" value="0">
                    </div>
                </div>
                ...
                <div class="activity-card">
                    ...
                    <div class="activity-actions">
                        ...
                        <input type="hidden" name="activites[Explorer les cascades d'Ouzoud]" value="0">
                    </div>
                </div>
                ...
                <div class="activity-card">
                    ...
                    <div class="activity-actions">
                        ...
                        <input type="hidden" name="activites[Se détendre dans un hammam traditionnel]" value="0">
                    </div>
                </div>
                ...
                <div class="activity-card">
                    ...
                    <div class="activity-actions">
                        ...
                        <input type="hidden" name="activites[Goûter aux saveurs du Maroc dans un souk]" value="0">
                    </div>
                </div>
            </section>
