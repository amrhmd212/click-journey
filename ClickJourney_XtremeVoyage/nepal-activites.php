                ...
                <div class="activity-grid">
                    ...
                    <div class="activity-card">
                        ...
                        <div class="activity-actions">
                            ...
                            <input type="hidden" name="activites[Saut en parachute Everest]" value="0">
                        </div>
                    </div>
                    ...
                    <div class="activity-card">
                        ...
                        <div class="activity-actions">
                            ...
                            <input type="hidden" name="activites[Gravir le mont Everest]" value="0">
                        </div>
                    </div>
                    ...
                    <div class="activity-card">
                        ...
                        <div class="activity-actions">
                            ...
                            <input type="hidden" name="activites[Vol en wingsuit sur l'Himalaya]" value="0">
                        </div>
                    </div>
                    ...
                    <div class="activity-card">
                        ...
                        <div class="activity-actions">
                            ...
                            <input type="hidden" name="activites[Free Solo sur une paroi de l'Himalaya]" value="0">
                        </div>
                    </div>
                    ...
                    <div class="activity-card">
                        ...
                        <div class="activity-actions">
                            ...
                            <input type="hidden" name="activites[Spéléologie dans les grottes glacées]" value="0">
                        </div>
                    </div>
                </div>
